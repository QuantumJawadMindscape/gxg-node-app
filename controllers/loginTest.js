...
export async function testLogin(req, res) {
  ...
  try {
    ...
    await page.goto(clientUrl, { waitUntil: "networkidle", timeout: 60000 });
    ...
    let clientId =
      ...
      (typeof clientJson === "string" ? parseInt(clientJson.replace(/"/g, "").trim()) : null) ||
      parseInt(clientRaw.replace(/[^0-9]/g, "").trim());
    ...
    await page.goto(accUrl, { waitUntil: "networkidle", timeout: 60000 });
    ...
    let accountId =
      ...
      (typeof accJson === "string" ? parseInt(accJson.replace(/"/g, "").trim()) : null) ||
      parseInt(accRaw.replace(/[^0-9]/g, "").trim());
